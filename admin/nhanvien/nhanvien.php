...
<div class="contrainer-fluid">
    <div class="card">
        ...
        <div class="trangchu">
            ...
            <?php } else if(isset($_SESSION['UserNamead'])) { ?>
        ...
        <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a  style="color: #f00;" href="../nhanvien/nhanvien.php">Tài khoản nhân viên</a></li>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query)){?>
                        <tr>
                            ...
                            <?php if(isset($_SESSION['dangnhap_nv'])) { ?>
                                <td><a href="sua_nhanvien.php?id=<?php echo $row['IDNhanVien']; ?>">Sửa</a></td>
                                <td>Không có quyền</td>
                            <?php } else { ?>
                                <td><a href="sua_nhanvien.php?id=<?php echo $row['IDNhanVien']; ?>">Sửa</a></td>
                                <td><a href="xoa_nhanvien.php?id=<?php echo $row['IDNhanVien']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa nhân viên này?')">Xóa</a></td>
                            <?php } ?>
                        </tr>
                     <?php }?>
                ...
                <?php if (!isset($_SESSION['dangnhap_nv'])) { ?>
                    <a class = "btn btn-primary" href="../nhanvien/them_nhanvien.php">Thêm mới</a>
                <?php } ?>
            </table>
        </div>
    </div>
