...
<div class="contrainer-fluid">
    <div class="card">
        ...
        <li class="dropdown">
                ...
                <li><a  style="color: #f00;" href="../thuonghieu/thuonghieu.php">Quản lý thương hiệu</a></li>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query)){?>
                        <tr>
                            ...
                            <td><?php echo isset($row['TenThuongHieu']) ? $row['TenThuongHieu'] : ''; ?></td>
                            <?php if(isset($_SESSION['dangnhap_nv'])) { ?>
                                <td><a href="sua_thuonghieu.php?id=<?php echo $row['IDThuongHieu']; ?>">Sửa</a></td>
                                <td>Không có quyền</td>
                            <?php } else { ?>
                                <td><a href="sua_thuonghieu.php?id=<?php echo $row['IDThuongHieu']; ?>">Sửa</a></td>
                                <td><a href="xoa_thuonghieu.php?id=<?php echo $row['IDThuongHieu']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa thương hiệu này?')">Xóa</a></td>
                            <?php } ?>
                ...
                <a class = "btn btn-primary" href ="them_thuonghieu.php">Thêm mới</a>
            </table>
        </div>
    </div>
</div>