    ...
    <div class="card">
        ...
        <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a  style="color: #f00;" href="../taikhoanadmin/admin.php">Tài khoản admin</a></li>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query)){?>
                        <tr>
                            ...
                            <?php } else { ?>
                                <td><?php echo $i++; ?></td>
                            <td><?php echo isset($row['IDAdmin']) ? $row['IDAdmin'] : ''; ?></td>
                            ...
                            <td><?php echo isset($row['DiaChi']) ? $row['DiaChi'] : ''; ?></td>
                                <td><a href="xoa_admin.php?id=<?php echo $row['IDAdmin']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa admin này?')">Xóa</a></td>
                            <?php } ?>
                ...
                <?php if(isset($_SESSION['dangnhap_nv'])) { ?>
                            ...
                            <?php } else { ?>
                                <a class = "btn btn-primary" href ="them_admin.php">Thêm mới</a>
                            <?php } ?>
