...
if (isset($_POST['sbm'])) {
    ...
    $checkQuery = "SELECT * FROM KhachHang WHERE UserName='$UserName' OR Email='$Email'";
    $checkResult = mysqli_query($con, $checkQuery);

    if (mysqli_num_rows($checkResult) > 0) {
        // Báo lỗi khi tên đăng nhập hoặc email đã tồn tại
        ...
        $sql = "INSERT INTO KhachHang(UserName, Pass, HoTen, Email, SDT, NgaySinh, DiaChi) 
...
<body>
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data" id="khachHangForm">
