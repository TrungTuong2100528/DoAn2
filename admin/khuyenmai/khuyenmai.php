...
<div class="contrainer-fluid">
    <div class="card">
        ...
        <li class="dropdown">
                ...
                <li><a  style="color: #f00;" href="../khuyenmai/khuyenmai.php">Quản lý khuyến mãi</a></li>
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query)){?>
                        <tr>
                            ...
                            <td><?php echo isset($row['GiaKhuyenMai']) ? number_format($row["GiaKhuyenMai"], 0, ',', '.') : ''; ?> VNĐ</td>
                            ...
                            <?php } else { ?>
                                <td><a href="sua_khuyenmai.php?id=<?php echo $row['IDKhuyenMai']; ?>">Sửa</a></td>
                            <td><a href="xoa_khuyenmai.php?id=<?php echo $row['IDKhuyenMai']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa khuyến mãi này?')">Xóa</a></td>
                        </tr>
                            <?php } ?>
