...
.sidebar li a[href="../nhanvien/nhanvien.php"]:before,
.sidebar li a[href="../nhanvien/nhanvien.php"]:after {
    content: ">> ";
    color: #f00; /* Màu của dấu hiệu, thay đổi theo ý muốn của bạn */
}
...
<div class="contrainer-fluid">
    <div class="card">
        ...
        <li class="dropdown">
                ...
                <li><a  style="color: #f00;" href="../baiviet/baiviet.php">Quản lý bài viết</a></li>
            ...
            <table class="table">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query)){?>
                        <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo isset($row['IDBaiViet']) ? $row['IDBaiViet'] : ''; ?></td>
                            <td><?php echo isset($row['IDSanPham']) ? $row['IDSanPham'] : ''; ?></td>
                            <td><?php echo isset($row['IDNhanVien']) ? $row['IDNhanVien'] : ''; ?></td>
                            <td><?php echo isset($row['TenBaiViet']) ? $row['TenBaiViet'] : ''; ?></td>
                            <?php if(isset($_SESSION['dangnhap_nv'])) { ?>
                                <td><a href="sua_baiviet.php?id=<?php echo $row['IDBaiViet']; ?>">Sửa</a></td>
                                <td>Không có quyền</td>
                            <?php } else { ?>
                                <td><a href="sua_baiviet.php?id=<?php echo $row['IDBaiViet']; ?>">Sửa</a></td>
                                <td><a href="xoa_baiviet.php?id=<?php echo $row['IDBaiViet']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa bài viết này?')">Xóa</a></td>
                            <?php } ?>
                    ...
                    <a class = "btn btn-primary" href ="them_baiviet.php">Thêm mới</a>
