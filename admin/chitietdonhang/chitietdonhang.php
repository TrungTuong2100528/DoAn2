...
<div class="contrainer-fluid">
    <div class="card">
        ...
        <li class="dropdown">
                ...
                <li><a  style="color: #f00;" href="../chitietdonhang/chitietdonhang.php">Quản lý chi tiết đơn hàng</a></li>
            ...
            <table class="table">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query)){?>
                        <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo isset($row['IDChiTietDonhang']) ? $row['IDChiTietDonhang'] : ''; ?></td>
                            ...
                            <td><?php echo isset($row['TongTien']) ? number_format($row["TongTien"]) : ''; ?> VNĐ</td>
                            <?php if(isset($_SESSION['dangnhap_nv'])) { ?>
                                <td><a href="sua_chitietdonhang.php?id=<?php echo $row['IDChiTietDonhang']; ?>">Sửa</a></td>
                                <td>Không có quyền</td>
                            <?php } else { ?>
                                <td><a href="sua_chitietdonhang.php?id=<?php echo $row['IDChiTietDonhang']; ?>">Sửa</a></td>
                            <td><a href="xoa_chitietdonhang.php?id=<?php echo $row['IDChiTietDonhang']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa chi tiết đơn hàng này này?')">Xóa</a></td>
                            <?php } ?>
