...
<body>
  ...
  <div class="abc">
    <h1>THIẾT BỊ Y TẾ CHUYÊN DỤNG</h1>
  </div>
  <div id="list-products">
    <div class="item">
      <img src="../image_giaodien/ThietBiYTeChuyenDung/Bom-tiem-su-dung-1-lantanaphar-bt-10ml.jpg" alt="">
      <a class="name">Bơm tiêm sử dụng một lần Tanaphar-BT 10ml</a>
      <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
    </div>
    <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung/Gang-tay-y-te-Top-Glove.jpg" alt="">
        <a class="name">Găng tay y tế Top Glove</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung/kinh-chong-giot-ban-300x300.jpg" alt="">
        <a class="name">Kính chống giọt bắn</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung/May-lam-am-lam-am-hoi-tho-tni-softflow-50.jpg" alt="">
        <a class="name">Máy làm ấm làm ẩm hơi thở TNI softFlow 50</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung//May-oxy-dong-cao-qua-mui-lifemed-hfnc-hfo-1.jpg" alt="">
        <a class="name">Máy oxy dòng cao qua mũi Lifemed HFNC HFO-1</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung/May-Phan-tich-khi-mau-dien-giai-i-smartcare10.jpg" alt="">
        <a class="name">Máy phân tích khí máu điện giải i-SmartCare10</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung/may-soc-tim-co-tao-nhip-rescue-life-1.jpg" alt="">
        <a class="name">Máy sốc tim có tạo nhịp Progetti RESCUE Life</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung/May-theo-doi-benh-nhan-5-thong-so-axcent-cetus-x12.jpg" alt="">
        <a class="name">Máy theo dõi bệnh nhân 5 thông số AXCENT Cetus X12</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung/May-tho-chuc-nang-cao-axcent-lyra-x1-3.jpg" alt="">
        <a class="name">Máy thở chức năng cao AXCENT Lyra X1</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung/ong-nghe-tim-phoi-Microlife-ST-77-1.jpg" alt="">
        <a class="name">Ống nghe tim phổi Microlife ST-77</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeChuyenDung/Trang-phuc-bao-ho-Green-GMC-1.jpg" alt="">
        <a class="name">Bộ trang phục bảo hộ y tế Green GMC</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
