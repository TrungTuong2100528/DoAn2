...
<body>
  ...
  <div id="list-products">
    ...
    <div class="item">
        <img src="../image_giaodien/ThietBiYTeGiaDinh/Bang-ca-nhan-Tigerplast-Sheer-R.jpg" alt="">
        <a class="name">Băng cá nhân màu da Tigerplast Sheer R</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeGiaDinh/Bang-dinh-cuon-tanaphar-ugotana-5cmx5m-3.jpg" alt="">
        <a class="name">Băng dính cuộn vải lụa y tế Tanaphar UGOTANA 5cmx5m</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeGiaDinh/can-dien-tu-Microlife-WS60A.jpg" alt="">
        <a class="name">Cân sức khỏe điện tử Microlife WS60A</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeGiaDinh/may-do-huyet-ap-microlife-b3-bluetooth.jpg" alt="">
        <a class="name">Máy đo huyết áp bắp tay Microlife B3 BLUETOOTH</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeGiaDinh/may-do-huyet-ap-microlife-bp-a6.jpg" alt="">
        <a class="name">Máy đo huyết áp bắp tay Microlife A6 Basic</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeGiaDinh/May-massage-dien-tu-Omron-HV-F013.png" alt="">
        <a class="name">Máy massage điện tử Omron HV-F013</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeGiaDinh/May-massage-Omron-HV-F021-1.jpg" alt="">
        <a class="name">Máy massage điện tử Omron HV F021</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeGiaDinh/nhiet-ke-dau-cung-khong-tham-nuoc-polygreen-classic-kd-1490-1.jpg" alt="">
        <a class="name">Nhiệt kế điện tử đầu cứng Polygreen Classic KD-1490</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
      <div class="item">
        <img src="../image_giaodien/ThietBiYTeGiaDinh/Nhiet-ke-dien-tu-do-tran-Omron-MC-720-1.png" alt="">
        <a class="name">Nhiệt kế điện tử đo trán Omron MC-720</a>
        <a href="../ThongTinSanPham/ThongTinSanPham.php"> <button>Xem</button></a> 
      </div>
